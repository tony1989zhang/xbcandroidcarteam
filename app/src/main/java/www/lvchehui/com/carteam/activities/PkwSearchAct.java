...
import www.lvchehui.com.carteam.adapter.BaseListAdapter;
...
@ContentView(R.layout.act_poikeywordsearche)
public class PkwSearchAct extends BaseAct implements PoiSearch.OnPoiSearchListener, TextWatcher
        , Inputtips.InputtipsListener, AdapterView.OnItemClickListener {

    @ViewInject(R.id.keyword)
    private ClearEt m_keyword;
...
//            aAdapter.notifyDataSetChanged();
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        PkwSearchEvent pkwSearchEvent = new PkwSearchEvent();
        pkwSearchEvent.setAddress(mDatas.get(position));
        EventBus.getDefault().post(pkwSearchEvent);
        finish();
    }
